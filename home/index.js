            ...
            <Col span={24}>
              <div className={styles.sectionThree}>
                <Tabs defaultActiveKey="1">
                  <TabPane
                    tab={<span>{i18n.t`Predication Game`}</span>}
                    key="1"
                    style={{ marginLeft: '0%' }}
                  >
                    <Row
                  ...
                  <TabPane
                    tab={<span>{i18n.t`Salary Cap Game`}</span>}
                    key="2"
                    ...
                    >
                      ...
                      <Col xs={24} lg={12}>
                        ...
                        <p className={styles.sliderP}>
                          Lorem Ipsum is unadulterated drivel. It means nothing
                          whatsoever, but it's surprisingly useful. The main
                          idea behind lorem ipsum is to have 'convincing' text,
                  ...
                  <TabPane
                    tab={<span>{i18n.t`Soon Games`}</span>}
                    key="3"
